  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <View style={DanhMucSPStyless.viewSearch}>
        <Image
          style={DanhMucSPStyless.imgBack}
        ...
        />
        <Image
          style={DanhMucSPStyless.imgRightInputSearch}
          source={require('../../image/Left2.png')}
        />
      </View>
      ...
      <View style={ItemProductStylesSP.Container}>
        <View style={{alignItems: 'center'}}>
          <View style={ItemProductStylesSP.View1}>
            <Image
              style={ItemProductStylesSP.Image1}
              source={require('../../image/Oppo.png')}
            />
          </View>
        ...
        <View style={{alignItems: 'center'}}>
          <View style={ItemProductStylesSP.View2}>
            <Image
              style={ItemProductStylesSP.Image2}
        ...
        <View style={{alignItems: 'center'}}>
          <View style={ItemProductStylesSP.View3}>
            <Image
              style={ItemProductStylesSP.Image3}
        ...
        <View style={{alignItems: 'center'}}>
          <View style={ItemProductStylesSP.View4}>
            <Image
              style={ItemProductStylesSP.Image4}
              source={require('../../image/Xiaomi.png')}
            />
          </View>
        ...
        <View style={{alignItems: 'center'}}>
          <View style={ItemProductStylesSP.View5}>
            <Image
              style={ItemProductStylesSP.Image5}
              source={require('../../image/Sony.png')}
            />
          </View>
        ...
        <View style={{alignItems: 'center'}}>
          <View style={ItemProductStylesSP.View5}>
            <Image
              style={ItemProductStylesSP.Image5}
              source={require('../../image/Nokia.png')}
            />
          </View>
