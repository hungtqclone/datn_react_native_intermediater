...
const NearYou = () => {
    ...
    const trimAddress = addr => {
        return addr.length > MAX_ADDRESS_LENGTH ? addr.substring(0, MAX_ADDRESS_LENGTH - 5) + '...' : addr;
    };
    ...
    return (
        <View style={styles.body}>
            <ScrollView>
                <TouchableOpacity style={styles.contAddress} onPress={handlePressAddress}>
                    <Image style={styles.imgaddress} source={require('../../assets/images/icons/icon_address.png')} />
                    <Text numberOfLines={1}>{`Vị trí: ${address}`}</Text>
                    <Image style={styles.icon_arrow_right} source={require('../../assets/images/icons/icon_arrow_right.png')} />
                </TouchableOpacity>
                <Modal isVisible={isModalVisible}>
                    <View style={styles.modalContainer}>
                        <View style={styles.modalContent}>
                            <Text style={styles.modalText}>Bạn có muốn cập nhật địa chỉ không?</Text>
                            <View style={styles.modalButtons}>
                                <TouchableOpacity style={styles.modalButton} onPress={handleUpdateAddress}>
                                    <Text style={styles.buttonText}>Có</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.modalButton} onPress={handleCancelUpdate}>
                ...
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Image style={styles.img} source={require('../../assets/images/icons/man-person-icon.png')} />
                        <View>
                            <View style={styles.nameshop}>
                                <Text style={styles.textnameshop}>
                                    Auto 380
                                </Text>
                                <Image style={styles.iconbag} source={require('../../assets/images/icons/icon_bag.png')} />
                            </View>
                        ...
                        <TouchableOpacity style={styles.btn} onPress={() => console.log('theo dõi')}>
                    ...
                    <View style={styles.bodycont}>
                        ...
                        <View style={styles.currentLocation} zIndex={2}>
                            <Image source={require('../../assets/images/icons/icon_address.png')} style={styles.imgaddress} />
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) => (
                                <View style={styles.gridItem}>
                                    <Image source={item.image} style={styles.image} />
                                    {index === 3 && (
                                        <TouchableOpacity style={styles.overlay} onPress={() => console.log('+2')}>
                        ...
                        <TouchableOpacity style={styles.nameprice}>
                            <View style={styles.cont_nameprice}>
                                <Text style={styles.textnameprice}>
                                    CHEVROLET AVEO 2017.
                                </Text>
                        ...
                        <View style={styles.infoPro} onLayout={checkContentHeight}>
                            ...
                            {showCollapseButton && (
                                <TouchableOpacity onPress={toggleExpand}>
                                    <Text style={styles.readMoreText}>{isExpanded ? 'Thu gọn' : 'Thêm'}</Text>
                                </TouchableOpacity>
                            )}
                        </View>
                    </View>
                    <View style={styles.btncontact}>
                        <TouchableOpacity style={styles.btnCall}>
                            <Image style={styles.iconCall} source={require('../../assets/images/icons/heart.png')} />
                            <Text style={styles.txtBtnCall}>
                                Lưu tin
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.btnCall}>
                            <Image style={styles.iconCall} source={require('../../assets/images/icons/icon_chat.png')} />
                            <Text style={styles.txtBtnCall}>
                                Chat
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.btnCall}>
                            <Image style={styles.iconCall} source={require('../../assets/images/icons/iconShare.png')} />
                            <Text style={styles.txtBtnCall}>
                                Chia sẻ
                            </Text>
                        </TouchableOpacity>
